// EXERCÍCIO 01 //
    ...
    a)  Como fazemos para acessar os parâmetros passados na linha de comando para o Node?
        Para acessar os parâmetros utilizamos o process.argv, nele colocamos qual a posição do parâmetro.
        Já no terminal chamamos node nome-do-arquivo argumento ou npm nome-do-script argumento
    */
