//--------------------------------------------- EXERCÍCIO 06 - DESAFIO ----------------------------------------------------------//
    ...
    /* Tendo este pequeno texto em mente, você deve criar uma função que determine a que idade histórica (em negrito no texto) um ano pertence.
    Ela deve esperar receber o ano e um outro parâmetro que seja a sigla "AC" ou "DC". Algumas características a mais desta função:
    ...
    const periodoHistorico = checaPeriodoHistorico(4045, sigla.DC)
